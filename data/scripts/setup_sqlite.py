...
DB_PATH = Path(__file__).parent.parent / "data" / "infra.db"
CSV_PATH = Path(__file__).parent.parent / "data" / "kyiv_infrastructure.csv"
DEPS_SQL_PATH = Path(__file__).parent.parent / "data" / "deps_sqlite.sql"
